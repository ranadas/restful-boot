            ...
            <ddm:TAXDATA TAXYEAR="{TAXYEAR}">
                <ddm:FD>
                    <ddm:FDA RECID="-1" OWNER="1" SOURCE="I" MODIFIEDON="{datetime:dateTime()}" ENGINERECID="-1">
                        <ddm:FDA_MORTGAGES RECID="-1" OWNER="1" SOURCE="I" MODIFIEDON="{datetime:dateTime()}" ENGINERECID="-1">
                            <xsl:if test="LENDERADDR">
                                <ddm:LENDER VALUE="{LENDERADDR/LENDERNAME}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                            </xsl:if>
                            <xsl:if test="MORTGAGEINTEREST">
                                <ddm:AMT_INT_1098 VALUE="{format-number(round(MORTGAGEINTEREST),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                            </xsl:if>
                            <xsl:if test="POINTS">
                                <ddm:AMT_POINTS_1098 VALUE="{format-number(round(POINTS),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                            </xsl:if>
                            <xsl:if test="../ACCTNUM">
                                <ddm:AccountNumber VALUE="{../ACCTNUM}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                            </xsl:if>
                            <xsl:if test="../SSN">
                            ...
                            <xsl:if test="LENDERADDR">
                                <xsl:if test="LENDERADDR/ADDR1">
                                    <ddm:LenderAddress1 VALUE="{LENDERADDR/ADDR1}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                </xsl:if>
                                <xsl:if test="LENDERADDR/ADDR2">
                                    <ddm:LenderAddress2 VALUE="{LENDERADDR/ADDR2}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                </xsl:if>
                                <xsl:if test="LENDERADDR/ADDR3">
                                    <ddm:LenderAddress3 VALUE="{LENDERADDR/ADDR3}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                </xsl:if>
                                <xsl:if test="BORROWERADDR/CITY">
                                    <ddm:LenderCity VALUE="{LENDERADDR/CITY}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                </xsl:if>
                                <xsl:if test="LENDERADDR/STATE">
                                    <ddm:LenderState VALUE="{LENDERADDR/STATE}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                </xsl:if>
                                <xsl:if test="LENDERADDR/POSTALCODE">
                                    <ddm:LenderZipCode VALUE="{LENDERADDR/POSTALCODE}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                </xsl:if>
                            </xsl:if>
                            ...
                            <xsl:if test="BORROWERADDR">
                                <ddm:BorrowerName VALUE="{BORROWERADDR/BORROWERNAME}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                <xsl:if test="BORROWERADDR/ADDR1">
                                    <ddm:BorrowerAddress1 VALUE="{BORROWERADDR/ADDR1}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                </xsl:if>
                                <xsl:if test="BORROWERADDR/ADDR2">
                                    <ddm:BorrowerAddress2 VALUE="{BORROWERADDR/ADDR2}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                </xsl:if>
                                <xsl:if test="BORROWERADDR/ADDR3">
                                    <ddm:BorrowerAddress3 VALUE="{BORROWERADDR/ADDR1}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                </xsl:if>
                                <xsl:if test="BORROWERADDR/CITY">
                                    <ddm:BorrowerCity VALUE="{BORROWERADDR/CITY}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                </xsl:if>
                                <xsl:if test="BORROWERADDR/STATE">
                                    <ddm:BorrowerState VALUE="{BORROWERADDR/STATE}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                </xsl:if>
                                <xsl:if test="BORROWERADDR/POSTALCODE">
                                    <ddm:BorrowerZIPCode VALUE="{BORROWERADDR/POSTALCODE}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                </xsl:if>
                            </xsl:if>
                            <xsl:if test="OVERPAIDREFUND">
                                <ddm:Overpaid_Amount VALUE="{format-number(round(OVERPAIDREFUND),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                            </xsl:if>
                            <xsl:if test="OTHERLOANINFO">
                                <ddm:OtherInfo VALUE="{OTHERLOANINFO}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                            </xsl:if>
                        </ddm:FDA_MORTGAGES>
                    </ddm:FDA>
                </ddm:FD>
                ...
                <ddm:GL>
                    <ddm:GLW2 RECID="-1" OWNER="1" SOURCE="I" MODIFIEDON="{datetime:dateTime()}" ENGINERECID="-1">
                        ...
                        <xsl:if test="STATUTORY">
                            <ddm:W2_Statutory_flag VALUE="{STATUTORY}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <!--
                        ...
                        <xsl:if test="ALLOCATEDTIPS">
                            <ddm:W2_Allocated_tips VALUE="{format-number(round(ALLOCATEDTIPS),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <xsl:if test="ADVANCEDEIC">
                            <ddm:W2_Advance_EIC VALUE="{format-number(round(ADVANCEDEIC),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <xsl:if test="FEDTAXWH">
                            <ddm:W2_Fed_WH VALUE="{format-number(round(FEDTAXWH),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <xsl:if test="WAGES">
                            <ddm:W2_wages VALUE="{format-number(round(WAGES),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <xsl:if test="SSTAXWH">
                            <ddm:W2_SS_WH VALUE="{format-number(round(SSTAXWH),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <xsl:if test="SSWAGES">
                            <ddm:W2_SS_wages VALUE="{format-number(round(SSWAGES),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <xsl:if test="SSTIPS">
                            <ddm:W2_SS_tips VALUE="{format-number(round(SSTIPS),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <xsl:if test="MEDICAREWAGES">
                            <ddm:W2_Medicare_wages VALUE="{format-number(round(MEDICAREWAGES),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <xsl:if test="MEDICARETAXWH">
                            <ddm:W2_Medicare_WH VALUE="{format-number(round(MEDICARETAXWH),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <xsl:if test="NONQUALPLAN">
                            <ddm:W2_NonQual_Plan VALUE="{format-number(round(NONQUALPLAN),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <xsl:if test="DEPCAREBENEFIT">
                            <ddm:W2_DCB VALUE="{format-number(round(DEPCAREBENEFIT),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        ...
                        <xsl:if test="THIRDPARTYSICKPAY">
                            <ddm:W2_3rdParty_flag VALUE="{THIRDPARTYSICKPAY}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        ...
                        <xsl:if test="EMPLOYEE/POSTALCODE">
                            <ddm:be_zip VALUE="{EMPLOYEE/POSTALCODE}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <xsl:if test="EMPLOYER/COUNTRYSTRING">
                            <ddm:EFOREIGNCOUNTRY  VALUE="{EMPLOYER/COUNTRYSTRING}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <xsl:if test="EMPLOYEE/COUNTRYSTRING">
                            <ddm:beforeign_country VALUE="{EMPLOYEE/COUNTRYSTRING}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <xsl:if test="EMPLOYER/ADDR2">
                            <ddm:EmployerAddress2 VALUE="{EMPLOYER/ADDR2}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <xsl:if test="EMPLOYER/ADDR3">
                            <ddm:EmployerAddress3 VALUE="{EMPLOYER/ADDR3}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        ...
                        <ddm:EmployeeFirstName VALUE="{EMPLOYEE/FIRSTNAME}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        <xsl:if test="EMPLOYEE/MIDDLENAME">
                            <ddm:EmployeeMidInitial VALUE="{EMPLOYEE/MIDDLENAME}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <ddm:EmployeeLastName VALUE="{EMPLOYEE/LASTNAME}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        <xsl:if test="SUFFIX">
                            <ddm:EmployeeSuffix VALUE="{EMPLOYEE/SUFFIX}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <xsl:if test="EMPLOYEE/ADDR2">
                            <ddm:EmployeeAddress2 VALUE="{EMPLOYEE/ADDR2}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <xsl:if test="EMPLOYEE/ADDR3">
                            <ddm:EmployeeAddress3 VALUE="{EMPLOYEE/ADDR3}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        ...
                        <xsl:if test="DEFERREDCOMP">
                            <ddm:DeferredCompensation VALUE="{format-number(round(DEFERREDCOMP),'#0')}" RECID="-1" OWNER="1" SOURCE="I" MODIFIEDON="{datetime:dateTime()}" ENGINERECID="-1"/>
                        </xsl:if>
                        <xsl:if test="DECEASED">
                            <ddm:DeceasedFlag VALUE="{DECEASED}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <xsl:if test="RETIREMENTPLAN">
                            <ddm:W2_PensionFlag VALUE="{RETIREMENTPLAN}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <!-- 15 Dec 2015 start -->
                        <xsl:if test="W2VERIFICATIONCODE">
                            <ddm:W2VERIFICATIONCODE VALUE="{W2VERIFICATIONCODE}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <!-- end -->
                        <xsl:if test="OTHER">
                            <xsl:for-each select="OTHER">
                                <ddm:GLW2_OTHERINFO RECID="-1" OWNER="1" SOURCE="I" MODIFIEDON="{datetime:dateTime()}" ENGINERECID="-1">
                                    <ddm:Description VALUE="{OTHERDESC}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                    <ddm:Amount VALUE="{format-number(round(OTHERAMOUNT),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                </ddm:GLW2_OTHERINFO>
                            </xsl:for-each>
                        </xsl:if>
                        <xsl:choose>
                                    ...
                                    <xsl:when test="$stcnt &lt; $lclcnt">
                                        <xsl:for-each select="STATEINFO">
                                            ...
                                            <xsl:for-each select="../LOCALINFO">
                                                <ddm:GLW2_STATEINFO RECID="-1" OWNER="1" SOURCE="I" MODIFIEDON="{datetime:dateTime()}" ENGINERECID="-1">
                                                    <xsl:if test="$stpos = position()">

                                                        <xsl:if test="../STATEINFO/STATECODE">

                                                            <ddm:ST_Name VALUE="{../STATEINFO/STATECODE}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                                        </xsl:if>
                                                        <xsl:if test="../STATEINFO/EMPLOYERSTID">
                                                            <ddm:ST_Id VALUE="{../STATEINFO/EMPLOYERSTID}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                                        </xsl:if>
                                                        <xsl:if test="../STATEINFO/STATEWAGES">
                                                            <ddm:ST_Wages VALUE="{format-number(round(../STATEINFO/STATEWAGES),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                                        </xsl:if>
                                                        <xsl:if test="../STATEINFO/STATETAXWH">
                                                            <ddm:ST_tax VALUE="{format-number(round(../STATEINFO/STATETAXWH),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                                        </xsl:if>
                                                    </xsl:if>
                                                    ...
                                                    <xsl:if test="LOCALITYSTATE">
                                                        <ddm:Loc_state VALUE="{LOCALITYSTATE}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                                    </xsl:if>
                                                    <!--  FY14 end -->
                                                </ddm:GLW2_STATEINFO>
                                            </xsl:for-each>
                                            ...
                                            <xsl:for-each select="../STATEINFO">
                                                ...
                                                <ddm:GLW2_STATEINFO RECID="-1" OWNER="1" SOURCE="I" MODIFIEDON="{datetime:dateTime()}" ENGINERECID="-1">
                                                    ...
                                                    <xsl:if test="STATECODE">
                                                        ...
                                                        <ddm:ST_Name VALUE="{STATECODE}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                                    </xsl:if>
                                                    <xsl:if test="EMPLOYERSTID">
                                                        <ddm:ST_Id VALUE="{EMPLOYERSTID}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                                    </xsl:if>
                                                    <xsl:if test="STATEWAGES">
                                                        <ddm:ST_Wages VALUE="{format-number(round(STATEWAGES),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                                    </xsl:if>
                                                    <xsl:if test="STATETAXWH">
                                                        <ddm:ST_tax VALUE="{format-number(round(STATETAXWH),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                                    </xsl:if>
                                                    <xsl:if test="$lclpos = position()">


                                                        <xsl:if test="../LOCALINFO/LOCALITY">
                                                            <ddm:Loc_Name VALUE="{../LOCALINFO/LOCALITY}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                                        </xsl:if>
                                                        <xsl:if test="../LOCALINFO/LOCALWAGES">
                                                            <ddm:Loc_Wages VALUE="{format-number(round(../LOCALINFO/LOCALWAGES),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                                        </xsl:if>
                                                        <xsl:if test="../LOCALINFO/LOCALTAXWH">
                                                            <ddm:Loc_tax VALUE="{format-number(round(../LOCALINFO/LOCALTAXWH),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                                        </xsl:if>
                                                        <!--  FY14 start -->
                                                        <xsl:if test="../LOCALINFO/LOCALITYSTATE">
                                                            <ddm:Loc_state VALUE="{../LOCALINFO/LOCALITYSTATE}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                                        </xsl:if>
                                                        <!--  FY14 end -->
                                                    </xsl:if>
                                                </ddm:GLW2_STATEINFO>
                                        ...
                                        <xsl:for-each select="STATEINFO">
                                            ...
                                            <ddm:GLW2_STATEINFO RECID="-1" OWNER="1" SOURCE="I" MODIFIEDON="{datetime:dateTime()}" ENGINERECID="-1">
                                                ...
                                                <xsl:if test="../LOCALINFO[$stateCount]/LOCALITY">
                                                    <ddm:Loc_Name VALUE="{../LOCALINFO[$stateCount]/LOCALITY}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                                </xsl:if>
                                                <xsl:if test="../LOCALINFO[$stateCount]/LOCALWAGES">
                                                    <ddm:Loc_Wages VALUE="{format-number(round(../LOCALINFO[$stateCount]/LOCALWAGES),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                                </xsl:if>
                                                <xsl:if test="../LOCALINFO[$stateCount]/LOCALTAXWH">
                                                    <ddm:Loc_tax VALUE="{format-number(round(../LOCALINFO[$stateCount]/LOCALTAXWH),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                                </xsl:if>
                                                <!--  FY14 start -->
                                                <xsl:if test="../LOCALINFO[$stateCount]/LOCALITYSTATE">
                                                    <ddm:Loc_state VALUE="{../LOCALINFO[$stateCount]/LOCALITYSTATE}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                                </xsl:if>
                                                <!--  FY14 end -->
                                            </ddm:GLW2_STATEINFO>
                                        </xsl:for-each>
                        ...
                        <xsl:if test="CODES">
                            <xsl:for-each select="CODES">
                                <ddm:GLW2_FRINGEBENEFITS RECID="-1" OWNER="1" SOURCE="I" MODIFIEDON="{datetime:dateTime()}" ENGINERECID="-1">
                                    <ddm:Code VALUE="{normalize-space(CODE)}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                    <ddm:Amount VALUE="{format-number(round(CODEAMOUNT),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                    ...
                    <xsl:choose>
                        <xsl:when test="EXTDBINFO_V100">
                            <xsl:for-each select="EXTDBINFO_V100/PROCDET_V100">
                                <ddm:FDD_S1_SALES RECID="-1" OWNER="1" SOURCE="I" MODIFIEDON="{datetime:dateTime()}" ENGINERECID="-1">

                                    <!-- TY2014 changes Nov 26 2014 start -->
                                    <xsl:if test="FORM8949CODE">
                                        <ddm:form8949Code VALUE="{FORM8949CODE}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                    </xsl:if>
                                    <xsl:if test="STATECODE2">
                                        <ddm:StateCode2 VALUE="{STATECODE2}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                    </xsl:if>

                                    <xsl:if test="STATEIDNUM2">
                                        <ddm:StateIdNum2 VALUE="{STATEIDNUM2}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                    </xsl:if>

                                    <xsl:if test="STATETAXWHELD2">
                                        <ddm:StateTaxWheld2 VALUE="{format-number(round(STATETAXWHELD2),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                    </xsl:if>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="SALEDESCRIPTION">
                                            <ddm:description VALUE="{SALEDESCRIPTION}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                        </xsl:when>
                                    ...
                                    <ddm:salesPrice VALUE="{format-number(round(SALESPR),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>

                                    <xsl:if test="FEDTAXWH">
                                        <ddm:FDD_TAX_WITHHELD VALUE="{format-number(round(FEDTAXWH),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                    </xsl:if>
                                    <xsl:if test="DTVAR">
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="WASHSALELOSSDISALLOWED">
                                            <ddm:WashSaleDisallowed VALUE="{format-number(round(WASHSALELOSSDISALLOWED),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                        </xsl:when>
                                        <xsl:when test="ADJUSTMENTAMT">
                                            <ddm:adjustmentAmount VALUE="{format-number(round(ADJUSTMENTAMT),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                        </xsl:when>
                                    </xsl:choose>
                                    <!-- TY2014 changes Nov 26 2014 end -->
                                    ...
                                    <xsl:choose>
                                        ...
                                        <xsl:when test="SALECODE">
                                            <ddm:saleCode VALUE="{SALECODE}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                        </xsl:when>
                                    </xsl:choose>
                                    <!-- TY2014 changes Nov 26 2014 end -->

                                    <ddm:PayerName1 VALUE="{../../PAYERADDR/PAYERNAME1}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                    <xsl:if test="../../PAYERADDR/PAYERNAME2">
                                        <ddm:PayerName2 VALUE="{../../PAYERADDR/PAYERNAME2}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                    </xsl:if>
                                    <ddm:PayerAddress1 VALUE="{../../PAYERADDR/ADDR1}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                    <xsl:if test="../../PAYERADDR/ADDR2">
                                        <ddm:PayerAddress2 VALUE="{../../PAYERADDR/ADDR2}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                    </xsl:if>
                                    <xsl:if test="../../PAYERADDR/ADDR3">
                                        <ddm:PayerAddress3 VALUE="{../../PAYERADDR/ADDR3}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                    </xsl:if>
                                    ...
                                    <ddm:PayerZipCode VALUE="{../../PAYERADDR/POSTALCODE}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                    <xsl:if test="../../PAYERADDR/PHONE">
                                        <ddm:PayerPhone VALUE="{../../PAYERADDR/PHONE}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}">
                                            <xsl:attribute name="VALUE">
                                    ...
                                    <xsl:if test="../../RECADDR">
                                        <ddm:RecipientName1 VALUE="{../../RECADDR/RECNAME1}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                        ...
                                        <xsl:if test="../../RECADDR/ADDR2">
                                            <ddm:RecipientAddr2 VALUE="{../../RECADDR/ADDR2}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                        </xsl:if>
                                        <xsl:if test="../../RECADDR/ADDR3">
                                            <ddm:RecipientAddr3 VALUE="{../../RECADDR/ADDR3}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                        </xsl:if>
                                        <xsl:if test="../../RECADDR/CITY">
                                            <ddm:RecipientCity VALUE="{../../RECADDR/CITY}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                        </xsl:if>
                                        <xsl:if test="../../RECADDR/STATE">
                                            <ddm:RecipientState VALUE="{../../RECADDR/STATE}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                        </xsl:if>
                                        <xsl:if test="../../RECADDR/POSTALCODE">
                                            <ddm:RecipientZipCode VALUE="{../../RECADDR/POSTALCODE}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                        </xsl:if>
                                        <xsl:if test="../../RECADDR/COUNTRYSTRING">
                                            <ddm:RecipientCountry VALUE="{../../RECADDR/COUNTRYSTRING}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                        </xsl:if>
                                    ...
                                    <xsl:if test="NUMSHRS">
                                        <ddm:NumShrs VALUE="{NUMSHRS}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                    </xsl:if>
                                    <xsl:if test="LONGSHORT">
                                        <ddm:HoldingPeriod VALUE="{LONGSHORT}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                    </xsl:if>
                                    ...
                                    <xsl:if test="SECNAME">
                                        <ddm:SecName VALUE="{SECNAME}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                    </xsl:if>
                                    <xsl:if test="COSTBASIS">
                                        <ddm:FAKE_BASIS VALUE="{format-number(round(COSTBASIS),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                    </xsl:if>
            ...
            <ddm:GL>
                <ddm:GL1099R RECID="-1" OWNER="1" SOURCE="I" MODIFIEDON="{datetime:dateTime()}" ENGINERECID="-1">
                    ...
                    <xsl:if test="GROSSDIST">
                        <ddm:gross VALUE="{format-number(round(GROSSDIST),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                    </xsl:if>
                    <xsl:if test="TAXAMT">
                        <ddm:taxable VALUE="{format-number(round(TAXAMT),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                    </xsl:if>
                    ...
                    <xsl:if test="CAPGAIN">
                        <ddm:cap_gain VALUE="{format-number(round(CAPGAIN),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                    </xsl:if>
                    <xsl:if test="FEDTAXWH">
                        <ddm:fed_wh VALUE="{format-number(round(FEDTAXWH),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                    </xsl:if>
                    <xsl:if test="EMPCONTINS">
                        <ddm:emp_cont VALUE="{format-number(round(EMPCONTINS),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                    </xsl:if>
                    ...
                    <xsl:if test="ANNCTRCTDIST">
                        <ddm:actuarial VALUE="{format-number(round(ANNCTRCTDIST),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                    </xsl:if>
                    ...
                    <xsl:for-each select="STTAXWHAGG">
                        <ddm:state_wh VALUE="{format-number(round(AMOUNT),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                    ...
                    <xsl:for-each select="LCLTAXWHAGG">
                        <ddm:local_wh VALUE="{format-number(round(AMOUNT),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                    ...
                    <xsl:if test="LCLTAXWHAGG/LCLDIST">
                        <ddm:local_dist VALUE="{LCLTAXWHAGG/LCLDIST}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                    </xsl:if>
                    ...
                    <xsl:if test="PAYERADDR/ADDR2">
                        <ddm:Payer_Address2 VALUE="{PAYERADDR/ADDR2}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                    </xsl:if>
                    <xsl:if test="PAYERADDR/ADDR3">
                        <ddm:Payer_Address3 VALUE="{PAYERADDR/ADDR3}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                    </xsl:if>
                    <xsl:if test="PAYERADDR/PHONE">
                        <ddm:PayerPhone SOURCE="I" MODIFIEDON="{datetime:dateTime()}">
                            <xsl:attribute name="VALUE">
                    ...
                    <xsl:for-each select="STTAXWHAGG">
                        <ddm:GL1099R_StateInfo RECID="-1" OWNER="1" SOURCE="I" MODIFIEDON="{datetime:dateTime()}" ENGINERECID="-1">
                            <xsl:if test="STDIST">
                                <ddm:StateDistribution VALUE="{format-number(round(STDIST),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                            </xsl:if>
                            <ddm:StateWithholding VALUE="{format-number(round(AMOUNT),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                    ...
                    <xsl:for-each select="LCLTAXWHAGG">
                        <ddm:GL1099R_LocalInfo RECID="-1" OWNER="1" SOURCE="I" MODIFIEDON="{datetime:dateTime()}" ENGINERECID="-1">
                            <xsl:if test="LCLDIST">
                                <ddm:LocalDistribution VALUE="{format-number(round(LCLDIST),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                            </xsl:if>
                            <ddm:LocalWithholding VALUE="{format-number(round(AMOUNT),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                            <ddm:LocalityName VALUE="{NAMELCL}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </ddm:GL1099R_LocalInfo>
                    </xsl:for-each>
                    <!-- BEGIN: added for the new OFX tags beginning TY2011 - EEI (2012.01.26) -->
                    <xsl:if test="AMTALLOCABLEIRR">
                        <ddm:AmtAllocableIRR VALUE="{format-number(round(AMTALLOCABLEIRR),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                    </xsl:if>
                    <xsl:if test="FIRSTYEARDESIGROTH">
                        <ddm:FirstYearDesigRoth VALUE="{FIRSTYEARDESIGROTH}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                    </xsl:if>
            ...
            <ddm:TAXDATA TAXYEAR="{TAXYEAR}">
                <ddm:FD>
                    <ddm:FDB RECID="-1" OWNER="1" SOURCE="I" MODIFIEDON="{datetime:dateTime()}" ENGINERECID="-1">
                        <ddm:FDB_L5_DIVIDEND RECID="-1" OWNER="1" SOURCE="I" MODIFIEDON="{datetime:dateTime()}" ENGINERECID="-1">
                            <!-- 1099DIV -->
                            <ddm:TYPE VALUE="O" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                            <ddm:source VALUE="{PAYERADDR/PAYERNAME1}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                            <xsl:if test="ORDDIV">
                                <ddm:gross VALUE="{format-number(round(ORDDIV),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                            </xsl:if>
                            <xsl:if test="TOTCAPGAIN">
                                <ddm:cgd VALUE="{format-number(round(TOTCAPGAIN),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                            </xsl:if>
                            ...
                            <xsl:if test="P28GAIN">
                                <ddm:mid_cgd VALUE="{format-number(round(P28GAIN),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                            </xsl:if>
                            <xsl:if test="UNRECSEC1250">
                                <ddm:S1250_gain VALUE="{format-number(round(UNRECSEC1250),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                            </xsl:if>
                            <xsl:if test="SEC1202">
                                <ddm:gain1202 VALUE="{format-number(round(SEC1202),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                            </xsl:if>
                            ...
                            <xsl:if test="QUALIFIEDDIV">
                                <ddm:QUAL_DIV VALUE="{format-number(round(QUALIFIEDDIV),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                            </xsl:if>
                            <xsl:if test="PAYERADDR/PAYERNAME2">
                                <ddm:PayerName2 VALUE="{PAYERADDR/PAYERNAME2}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                            </xsl:if>
                                ...
                                <xsl:when test="ADDLSTATETAXWHAGG">
                                    <xsl:for-each select="ADDLSTATETAXWHAGG">
                                        ...
                                        <xsl:if test="position() = 2">
                                            <xsl:if test="STATECODE">
                                                <ddm:StateCode2 VALUE="{STATECODE}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                            </xsl:if>
                                            <xsl:if test="STATEIDNUM">
                                                <ddm:StateIdNum2 VALUE="{STATEIDNUM}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                            </xsl:if>
                                            <xsl:if test="STATETAXWHELD">
                                                <ddm:StateTaxWheld2 VALUE="{format-number(round(STATETAXWHELD),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                            </xsl:if>
                                        </xsl:if>
                                    </xsl:for-each>
                                </xsl:when>
                    ...
                    <ddm:FDB RECID="-1" OWNER="1" SOURCE="I" MODIFIEDON="{datetime:dateTime()}" ENGINERECID="-1">
                        <ddm:FDB_L5_DIVIDEND RECID="-1" OWNER="1" SOURCE="I" MODIFIEDON="{datetime:dateTime()}" ENGINERECID="-1">
                            ...
                            <xsl:if test="EXEMPTINTDIV">
                                <ddm:ExemptIntDiv VALUE="{format-number(round(EXEMPTINTDIV),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                            </xsl:if>
                            <xsl:if test="SPECIFIEDPABINTDIV">
                                <ddm:SpecifiedPabIntDiv  VALUE="{format-number(round(SPECIFIEDPABINTDIV),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                            </xsl:if>
                            <!-- 2013 changes to OFX addendum Oct8th 2012 end -->
                        </ddm:FDB_L5_DIVIDEND>
                    </ddm:FDB>
...
<xsl:template match="TAX1099INT_V100">
    <xsl:for-each select=".">
        <xsl:choose>
            <xsl:when test="( ( (INTINCOME) or (ERLWITHPEN) or (INTUSBNDTRS) or (FEDTAXWH) or (INVESTEXP) or (FORTAXPD) or (FORCNT) ) and not ((TAXEXEMPTINT) or (SPECIFIEDPABINT)) )"> <!-- (1 or 7) and no (8 or 9) -->
                <ddm:TAXDATA TAXYEAR="{TAXYEAR}">
                    ...
                    <ddm:FD>
                        <ddm:FDB RECID="-1" OWNER="1" SOURCE="I" MODIFIEDON="{datetime:dateTime()}" ENGINERECID="-1">
                            ...
                            <ddm:FDB_L1_INTEREST RECID="-1" OWNER="1" SOURCE="I" MODIFIEDON="{datetime:dateTime()}" ENGINERECID="-1">
                                <!--1099INT-->
                                <ddm:Int_Source VALUE="{PAYERADDR/PAYERNAME1}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                <xsl:if test="INTINCOME">
                                    <ddm:Int_Box1 VALUE="{format-number(round(INTINCOME),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                </xsl:if>
                                <xsl:if test="ERLWITHPEN">
                                    <ddm:Int_Box2 VALUE="{ERLWITHPEN}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                </xsl:if>
                                <!-- Int_Box3 uncommented by Aparna -->
                                <xsl:if test="INTUSBNDTRS">
                                    <ddm:Int_Box3 VALUE="{format-number(round(INTUSBNDTRS),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                </xsl:if>
                                <xsl:if test="FEDTAXWH">
                                    <ddm:Int_Box4 VALUE="{format-number(round(FEDTAXWH),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                </xsl:if>
                                <xsl:if test="INVESTEXP">
                                    <ddm:Int_Box5 VALUE="{format-number(round(INVESTEXP),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                </xsl:if>
                                <xsl:if test="FORTAXPD">
                                ...
                                <xsl:if test="TAXEXEMPTINT">
                                    <ddm:INT_EXEMPT VALUE="{format-number(round(TAXEXEMPTINT),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                </xsl:if>
                                <ddm:DISPLAY_NAME VALUE="{PAYERADDR/PAYERNAME1}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                <xsl:if test="INTINCOME">
                                    <ddm:DISPLAY_AMOUNT VALUE="{format-number(round(INTINCOME),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                </xsl:if>
                                <xsl:if test="SPECIFIEDPABINT">
                                    <ddm:INT_AMT_AMOUNT VALUE="{format-number(round(SPECIFIEDPABINT),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                </xsl:if>
                                <!-- TY2014 changes Nov 26 2014 start -->
                                <xsl:if test="MARKETDISCOUNT">
                                    <ddm:marketDiscount VALUE="{format-number(round(MARKETDISCOUNT),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                </xsl:if>
                                <xsl:if test="BONDPREMIUM">
                                    <ddm:bondPremium VALUE="{format-number(round(BONDPREMIUM),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                </xsl:if>
                                <!-- ty2014 changes nov 26 2014 end -->
                                <!-- TY2015 changes Dec 17 2015 start -->
                                <xsl:if test="TEBONDPREMIUM">
                                    <ddm:EXEMPTBONDPREMIUM VALUE="{format-number(round(TEBONDPREMIUM),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                </xsl:if>
                                <!-- TY2015 changes Dec 17 2015 end -->
            ...
            <xsl:when test="( ( (INTINCOME) or (ERLWITHPEN) or (INTUSBNDTRS) or (FEDTAXWH) or (INVESTEXP) or (FORTAXPD) or (FORCNT) ) and ((TAXEXEMPTINT) or (SPECIFIEDPABINT)) )"> <!-- Have (1 thro 7) and (8 or 9) -->
                <ddm:TAXDATA TAXYEAR="{TAXYEAR}">
        ...
        <ddm:TAXDATA TAXYEAR="{TAXYEAR}">
            <ddm:FD>
                <ddm:FDB RECID="-1" OWNER="1" SOURCE="I" MODIFIEDON="{datetime:dateTime()}" ENGINERECID="-1">
                    <ddm:FDB_L1_INTEREST RECID="-1" OWNER="1" SOURCE="I" MODIFIEDON="{datetime:dateTime()}" ENGINERECID="-1">
                        <!--1099OID-->
                        <ddm:OID_Source VALUE="{PAYERADDR/PAYERNAME1}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        <xsl:if test="ORIGISDISC">
                            <ddm:OID_Box1 VALUE="{format-number(round(ORIGISDISC),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <xsl:if test="OTHERPERINT">
                            <ddm:OID_Box2 VALUE="{format-number(round(OTHERPERINT),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <xsl:if test="ERLWITHPEN">
                            <ddm:OID_Box3 VALUE="{format-number(round(ERLWITHPEN),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <xsl:if test="FEDTAXWH">
                            <ddm:OID_Box4 VALUE="{format-number(round(FEDTAXWH),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <xsl:if test="OIDONUSTRES">
                            <ddm:OID_Box6 VALUE="{format-number(round(OIDONUSTRES),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <xsl:if test="INVESTEXP">
                            <ddm:OID_Box7 VALUE="{format-number(round(INVESTEXP),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>


                        <!-- TY2014 changes Nov 26 2014 start -->
                        <xsl:if test="MARKETDISCOUNT">
                            <ddm:oidMarketDiscount VALUE="{format-number(round(MARKETDISCOUNT),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <xsl:if test="ACQPREMIUM">
                            <ddm:oidAcquisitionPremium VALUE="{format-number(round(ACQPREMIUM),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <!-- TY2014 changes Nov 26 2014 end -->
                        ...
                        <xsl:choose>
                            <xsl:when test="ADDLSTATETAXWHAGG">
                                <xsl:for-each select="ADDLSTATETAXWHAGG">
                                    <xsl:if test="position() = 1">
                                        <xsl:if test="STATECODE">
                                            <ddm:OIDStateCode VALUE="{STATECODE}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                        </xsl:if>
                                        <xsl:if test="STATEIDNUM">
                                            <ddm:OIDStateIdNum VALUE="{STATEIDNUM}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                        </xsl:if>
                                        <xsl:if test="STATETAXWHELD">
                                            <ddm:OIDStateTaxWheld VALUE="{format-number(round(STATETAXWHELD),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                        </xsl:if>
                                    </xsl:if>
                                    <xsl:if test="position() = 2">
                                        <xsl:if test="STATECODE">
                                            <ddm:OIDStateCode2 VALUE="{STATECODE}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                        </xsl:if>
                                        <xsl:if test="STATEIDNUM">
                                            <ddm:OIDStateIdNum2 VALUE="{STATEIDNUM}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                        </xsl:if>
                                        <xsl:if test="STATETAXWHELD">
                                            <ddm:OIDStateTaxWheld2 VALUE="{format-number(round(STATETAXWHELD),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                                        </xsl:if>
                                    </xsl:if>
                                </xsl:for-each>
                            </xsl:when>
                        ...
                        <ddm:DISPLAY_NAME VALUE="{PAYERADDR/PAYERNAME1}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        <xsl:if test="OIDONUSTRES">
                            <ddm:DISPLAY_AMOUNT VALUE="{format-number(round(OIDONUSTRES),'#0')}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
                        <xsl:if test="PAYERADDR/PAYERNAME2">
                            <ddm:PayerName2 VALUE="{PAYERADDR/PAYERNAME2}" SOURCE="I" MODIFIEDON="{datetime:dateTime()}"/>
                        </xsl:if>
